...
const requiredEnvVars = ['BOT_NAME', 'BOT_PASSWORD', 'MUD_HOST', 'MUD_PORT', 'AI_MODEL', 'MARKOV_API', 'SLM_API'];
...
const DANDY_PROMPT = "You are a 19th century Southern dandy, with a sharp wit and a love for fashion and culture."

const DEFAULT_PROMPTS = [ANIME_PROMPT, SNARKY_PROMPT, SMART_PROMPT, PUNK_PROMPT, DANDY_PROMPT];
